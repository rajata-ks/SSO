...
var RestaurantController = /** @class */ (function () {
    ...
    RestaurantController.prototype.addRestaurant = function (res, jsonObj) {
        return __awaiter(this, void 0, void 0, function () {
            var conflict, success, output;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.model.find({ restaurantAddress: jsonObj.restaurantAddress })
                                ...
                                if (res.length === 0) {
                                    ...
                                    _this.createRestaurant(jsonObj);
                                    return success;
                                }
                                else {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, res.json(output)];
                }
            });
        });
    };
    RestaurantController.prototype.createRestaurant = function (jsonObj) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                this.model.create([jsonObj], function (err, response) {
                    if (err) {
